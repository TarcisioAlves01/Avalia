  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
        <h1>Enviar trabalho acadêmico</h1>
        <hr>
                ...
                <form action="controle" method="post" enctype="multipart/form-data">
                    ...
                    <p>
                        <div class="form-label-group">
                            <input type="text" name="titulo_artigo" id="firstName" class="form-control" placeholder="Número de Inscrição" required="required" autofocus="autofocus" />
                            <label for="firstName">Título do trabalho: </label>
                        </div>
                    </p>
                    <p>
                        <div class="form-label-group">
                            <input type='file' name="arquivo_artigo" accept=".pdf id="firstName" class="form-control" placeholder="Número de Inscrição" required="required" autofocus="autofocus"/>
                            <label for="firstName">Arquivo:</label>
                        </div>
                    </p>
                    
                    <input type="submit" value="Enviar trabalho" class="btn btn-primary btn-group"/>
                    </p>
                </form>              
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="login.html">Enviar artigo</a>
        </div>
      </div>
    </div>
  </div>
