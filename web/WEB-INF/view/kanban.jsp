    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    <th class="table-danger">To Do</th>
                    <th class="table-primary">Doing</th>
                    <th class="table-success">Done</th>                   
                  </tr>
                </thead>
                <tbody>
                    <tr>
                          <td> 
                                <c:forEach items="${ListaArtigos}" var="artigo">        
                                   ...
                                   <c:if test ="${artigo.fase == '2' }">
                                       <p>
                                            <b>Título: ${artigo.titulo}</b> - ${artigo.dataPublic} <br/>   
                                ...
                                <c:forEach items="${ListaArtigos}" var="artigo">        
                                   ...
                                   <c:if test ="${artigo.fase == '3' }">
                                       <p>
                                            ...
                                            <a href="/Avalia/controle?acao=Kanban&subacao=3&codigo_artigo=${artigo.codigo}&codigo_usuario=${artigo.solicitante}">Avaliar</a> - 
