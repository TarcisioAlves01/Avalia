                ...
                <form action="controle" method="post">
                    ...
                    <p>
                        <div class="form-label-group">
                            <input type="text" name="inscricao" value="${user.inscricao}" id="firstName" class="form-control" placeholder="Número de Inscrição" required="required" autofocus="autofocus" />
                            <label for="firstName">Número de Inscrição:</label>
                        </div>
                    </p>
                    <p>
                        <div class="form-label-group">
                            <input type="text" name="nome" value="${user.nome}" id="firstName" class="form-control" placeholder="Número de Inscrição" required="required" autofocus="autofocus"/>
                    ...
                    <p>
                        <div class="form-label-group">
                            Tipo de Usuário:
                            <select name="tipo" id="firstName" class="form-control" placeholder="Número de Inscrição" required="required" autofocus="autofocus">                     
                    ...
                    <p>
                        <div class="form-label-group">
                            <input type="email" name="email" value="${user.email}" id="firstName" class="form-control" placeholder="Número de Inscrição" required="required" autofocus="autofocus"/>
                            <label for="firstName">E-mail:</label>
                        </div>
                    </p>
                    <p>
                        <div class="form-label-group" >
                            <input type="password" name="senha1" value="${user.senha}" id="firstName" class="form-control" placeholder="Número de Inscrição" required="required" autofocus="autofocus"/>
                            <label for="firstName">Senha:</label>
                        </div>
                    </p>
                    <p>
                        <div class="form-label-group">
                            <input type="password" name="senha2" value="${user.senha2}" id="firstName" class="form-control" placeholder="Número de Inscrição" required="required" autofocus="autofocus"/>
                            <label for="firstName">Confirme a senha:</label>
                        </div>
                    </p>
                    <p>
                    <input type="submit" value="Alterar cadastrar" class="btn btn-primary btn-group"/>
                    </p>
                </form>
